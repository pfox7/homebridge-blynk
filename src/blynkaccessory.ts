...
export const pluginName = 'homebridge-blynk'
export const platformName = 'Blynk'
...
export class BlynkAccessory {
	...
	constructor(device: any, services: BlynkService[], hapAccessory: any, hapService: any, hapCharacteristic: any, platform) {
